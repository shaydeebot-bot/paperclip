...
name: documentation
description: >
  Write and maintain technical documentation — READMEs, API docs, runbooks, architecture docs,
  and onboarding guides. Provides templates and principles for clear, maintainable technical
