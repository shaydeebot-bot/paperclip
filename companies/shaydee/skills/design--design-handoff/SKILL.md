...
name: design-handoff
description: >
  Create comprehensive developer handoff documentation from designs. Covers visual specs,
  interaction details, content rules, edge cases, and accessibility requirements so developers
  can implement designs accurately without guessing.
---
