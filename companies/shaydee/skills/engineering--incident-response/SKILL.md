...
description: >
  Triage and manage production incidents from detection through resolution and postmortem.
  Covers severity classification, response framework, communication templates, and blameless
  postmortem methodology. Use when production issues need immediate structured response.
---
